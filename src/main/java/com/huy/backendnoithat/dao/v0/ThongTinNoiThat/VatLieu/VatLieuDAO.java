package com.huy.backendnoithat.dao.v0.ThongTinNoiThat.VatLieu;
...
public interface VatLieuDAO {
    ...
    void copySampleDataFromAdmin(int id, int parentId, String hangMucName, String noithatName, String phongcachName);
