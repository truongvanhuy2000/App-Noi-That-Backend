...
import com.huy.backendnoithat.usecase.account.management.manager.AccountEntityManager;
...
public class AccountManagementService {
    ...
    public PaginationResponse<List<Account>> search(
        ...
        log.info("Searching accounts with paginationRequest {} and userSearchRequest {}", paginationRequest, userSearchRequest);
    ...
    public void update(int id, Account account) {
        log.info("Updating account with ID: {} account {}", id, account);
    ...
    public void updateAccountActivationStatus(int id, boolean active) {
        log.info("Updating account activation status for account with ID: {} status: {}", id, active);
    ...
    public void deleteById(int id) {
        ...
        accountCleanupService.afterDeleteAccount(id);
    }
}
