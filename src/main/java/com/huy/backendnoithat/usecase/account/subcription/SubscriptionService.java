package com.huy.backendnoithat.usecase.account.subcription;
...
public class SubscriptionService {
    ...
    public SubscriptionModelDTO createSubscription(SubscriptionModelDTO subscriptionModelDTO) {
        log.info("Creating subscription with data: {}", subscriptionModelDTO);
    ...
    public void deleteSubscriptionModel(int id) {
        log.info("Deleting subscription model with ID: {}", id);
    ...
    public SubscriptionModelDTO updateSubscription(int id, SubscriptionModelDTO subscriptionModelDTO) {
        log.info("Updating subscription model with ID: {} subscriptionModelDTO {}", id, subscriptionModelDTO);
