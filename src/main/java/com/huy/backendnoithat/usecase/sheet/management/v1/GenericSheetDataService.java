package com.huy.backendnoithat.usecase.sheet.management.v1;
...
public class GenericSheetDataService {
    ...
    public void sampleAll(long userID, boolean overwrite) {
        log.info("START -- Sampling all data for user {} with overwrite {}", userID, overwrite);
        ...
        log.info("END -- Sampling all data for user {}", userID);
    }
}
