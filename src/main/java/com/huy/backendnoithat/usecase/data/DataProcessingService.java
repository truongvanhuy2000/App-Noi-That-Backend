package com.huy.backendnoithat.usecase.data;

import com.huy.backendnoithat.model.enums.DataOperation;
import com.huy.backendnoithat.usecase.data.compression.DataCompressService;
...
public class DataProcessingService {
    ...
    public byte[] processData(byte[] data, DataOperation dataOperation) {
        log.info("processData {}", dataOperation);
